...
@patch('lambda_22128867.canary.canary.check_page_load', return_value=(200, 1, 0.1))
@patch('lambda_22128867.canary.canary.put_metrics')
@patch('lambda_22128867.canary.canary.send_alert')
...
@patch('lambda_22128867.canary.canary.check_page_load', return_value=(0, 0, 0))
@patch('lambda_22128867.canary.canary.put_metrics')
@patch('lambda_22128867.canary.canary.send_alert')
